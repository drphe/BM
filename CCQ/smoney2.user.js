...
// @author       Drphe
// @match        https://smoney.com.vn/*
// @updateURL    https://vnindex.vercel.app/CCQ/smoney2.user.js
// @downloadURL  https://vnindex.vercel.app/CCQ/smoney2.user.js
// ==/UserScript==
(function() {
    'use strict';
    const total = [...document.querySelectorAll("div.floorbg.stock")].reduce((sum, div) => {
        const value = parseFloat(div.textContent.trim().replace(/,/g, ""));
        return sum + (isNaN(value) ? 0 : value);
    }, 0);
    if (total > 50) alert(`Chú ý phiên hoảng loạn! \nCó ${total} mã CP sàn`)
    if (window.location.pathname.startsWith("/co-phieu")) {
